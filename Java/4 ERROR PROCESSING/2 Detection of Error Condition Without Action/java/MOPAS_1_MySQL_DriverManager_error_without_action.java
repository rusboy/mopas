...
@WebServlet(urlPatterns = {"/MOPAS_1_MySQL_DriverManager_error_without_action"})
public class MOPAS_1_MySQL_DriverManager_error_without_action extends HttpServlet{
